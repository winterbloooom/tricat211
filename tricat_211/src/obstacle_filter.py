...
class ObstacleFilter:
    def __init__(self):
        ...
        self.filter_obstacles_pub = rospy.Publisher("/filtering_obstacles", FilteringObstacles, queue_size=10)
    ...
    def obstacle_filtering(self):
        ...
        for i in range(len(self.obstacle_list)):
            ...
            if distance_decision(self.decision_range, ob_d):
    ...
    def filteringObstaclesPublisher(self):
        filtering_ob_list = FilteringObstacles()
...
def distance_boat_to_wall(start_x, start_y, end_x, end_y):
...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        #rospy.loginfo(f.obstacle_filtering())
        #rospy.loginfo(f.wall_filtering())
