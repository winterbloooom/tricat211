void rc(){
  ...
  if (1100<ch2<1900)
  {
    val2 = map(ch2, 1900, 1100, 79, 107);  //중앙값 93 +- 14
    servo1.write(val2);
...
/*
  if (1100< ch2 < 1450)
  {
    ...
    servo1.writeMicroseconds(val2);
    servo2.writeMicroseconds(val2 - 2);
    delay(100);
  }
  else if ( 1450< ch2 < 1550)
  {
    servo1.writeMicroseconds(94);
    servo2.writeMicroseconds(92);
    delay(100);
  }
